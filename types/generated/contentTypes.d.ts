...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    mainContentBox: Attribute.Component<'ui.cc-box'>;
    subArticles: Attribute.Component<'content.subarticle', true>;
    slug: Attribute.UID<'api::article.article', 'title'> & Attribute.Required;
    prevArticle: Attribute.Relation<
      'api::article.article',
      'oneToOne',
      'api::article.article'
    >;
    nextArticle: Attribute.Relation<
      'api::article.article',
      'oneToOne',
      'api::article.article'
    >;
...
export interface ApiCareerItemCareerItem extends Schema.CollectionType {
  ...
  attributes: {
    description: Attribute.Text;
    contentBox: Attribute.Component<'ui.cc-box'>;
...
export interface ApiHdwwItemHdwwItem extends Schema.CollectionType {
  collectionName: 'hdww_items';
  info: {
    singularName: 'hdww-item';
    pluralName: 'hdww-items';
    displayName: 'HDWW Item';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    contentIcon: Attribute.Component<'ui.icon'>;
    contentTextColor: Attribute.String &
      Attribute.CustomField<'plugin::color-picker.color'>;
...
export interface ApiHeroHero extends Schema.SingleType {
  ...
  attributes: {
    newsCarouselItem: Attribute.Relation<
      'api::hero.hero',
      'oneToOne',
      'api::news-carousel-item.news-carousel-item'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiNewsCarouselItemNewsCarouselItem
  extends Schema.CollectionType {
  collectionName: 'news_carousel_items';
  info: {
    singularName: 'news-carousel-item';
    pluralName: 'news-carousel-items';
    displayName: 'News Carousel Item';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    contentBox: Attribute.Component<'ui.cc-box'> & Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::hdww-item.hdww-item': ApiHdwwItemHdwwItem;
      'api::hero.hero': ApiHeroHero;
      'api::news-carousel-item.news-carousel-item': ApiNewsCarouselItemNewsCarouselItem;
    }
  }
}
